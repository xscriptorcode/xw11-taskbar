...
Full **Windhawk + YASB** customization using the [Praha](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the Praha palette.
...
with hairline highlights, soft inner shadows and pressed states. The Praha palette
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#1a1a1a` / `#1a1a1a` | Bar background, surfaces |
| `color8` | `#6272a4` | Elevated surfaces, menus |
| `color7` / `foreground` | `#ffffff` | Text, icons |
| `color6` | `#8be9fd` | Primary accent, active, hover |
| `color1` | `#ff5555` | Close window, power, warnings |
| `color2` | `#b8e6a0` | Battery, success |
| `color3` | `#ffe4a3` | Weather, alerts |
| `color4` | `#bd93f9` | Disk, high load |
| `color5` | `#ff9aa2` | Media, network, GPU |
