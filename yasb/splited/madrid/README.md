...
Full **Windhawk + YASB** customization using the [Madrid](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the Madrid palette.
...
with hairline highlights, soft inner shadows and pressed states. The Madrid palette
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#fafafa` / `#fafafa` | Bar background, surfaces |
| `color8` | `#4d4d4d` | Elevated surfaces, menus |
| `color7` / `foreground` | `#1a1a1a` | Text, icons |
| `color6` | `#007a9e` | Primary accent, active, hover |
| `color1` | `#990026` | Close window, power, warnings |
| `color2` | `#007a28` | Battery, success |
| `color3` | `#8a6408` | Weather, alerts |
| `color4` | `#007a9e` | Disk, high load |
| `color5` | `#4d2699` | Media, network, GPU |
