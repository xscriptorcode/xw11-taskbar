...
Full **Windhawk + YASB** customization using the [Tokio](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the Tokio palette.
...
with hairline highlights, soft inner shadows and pressed states. The Tokio palette
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#1c1c1d` / `#1c1c1d` | Bar background, surfaces |
| `color8` | `#1c1c1d` | Elevated surfaces, menus |
