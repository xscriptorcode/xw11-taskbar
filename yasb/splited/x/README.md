...
Full **Windhawk + YASB** customization using the [X](https://github.com/xscriptor-colors/assets/blob/main/docs/palettes.md) palette.
...
settings, borders, corners and menus) with the X palette.
...
with hairline highlights, soft inner shadows and pressed states. The X palette
is used with restraint — a single cyan accent for interaction, signature pink
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#0a0a0a` / `#050505` | Bar background, surfaces |
| `color8` | `#0f0f0f` | Elevated surfaces, menus |
