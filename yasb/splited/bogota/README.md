...
Full **Windhawk + YASB** customization using the [Bogota](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the Bogota palette.
...
with hairline highlights, soft inner shadows and pressed states. The Bogota palette
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#200b0a` / `#200b0a` | Bar background, surfaces |
| `color8` | `#525053` | Elevated surfaces, menus |
| `color7` / `foreground` | `#f7f1ff` | Text, icons |
| `color6` | `#47e6ff` | Primary accent, active, hover |
| `color1` | `#fc618d` | Close window, power, warnings |
| `color2` | `#7bd88f` | Battery, success |
| `color3` | `#ffed89` | Weather, alerts |
| `color4` | `#47e6ff` | Disk, high load |
| `color5` | `#ff9999` | Media, network, GPU |
