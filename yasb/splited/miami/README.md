...
Full **Windhawk + YASB** customization using the [Miami](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the Miami palette.
...
with hairline highlights, soft inner shadows and pressed states. The Miami palette
...
| `color8` | `#69676c` | Elevated surfaces, menus |
| `color7` / `foreground` | `#f7f1ff` | Text, icons |
| `color6` | `#47cfff` | Primary accent, active, hover |
| `color1` | `#ff4c8b` | Close window, power, warnings |
| `color2` | `#7fffd4` | Battery, success |
| `color3` | `#ffd84c` | Weather, alerts |
| `color4` | `#00ffa8` | Disk, high load |
| `color5` | `#d36cff` | Media, network, GPU |
