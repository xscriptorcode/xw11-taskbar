...
Full **Windhawk + YASB** customization using the [Paris](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the Paris palette.
...
with hairline highlights, soft inner shadows and pressed states. The Paris palette
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#1a0a30` / `#1a0a30` | Bar background, surfaces |
| `color8` | `#c4bdff` | Elevated surfaces, menus |
| `color7` / `foreground` | `#f7f1ff` | Text, icons |
| `color6` | `#a3f3ff` | Primary accent, active, hover |
| `color1` | `#fc618d` | Close window, power, warnings |
| `color2` | `#7bd88f` | Battery, success |
| `color3` | `#fce566` | Weather, alerts |
| `color4` | `#a3f3ff` | Disk, high load |
| `color5` | `#c4bdff` | Media, network, GPU |
