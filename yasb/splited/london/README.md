...
Full **Windhawk + YASB** customization using the [London](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the London palette.
...
with hairline highlights, soft inner shadows and pressed states. The London palette
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#ffffff` / `#ffffff` | Bar background, surfaces |
| `color8` | `#333333` | Elevated surfaces, menus |
| `color7` / `foreground` | `#333333` | Text, icons |
| `color6` | `#888888` | Primary accent, active, hover |
| `color1` | `#333333` | Close window, power, warnings |
| `color2` | `#444444` | Battery, success |
| `color3` | `#555555` | Weather, alerts |
| `color4` | `#666666` | Disk, high load |
| `color5` | `#777777` | Media, network, GPU |
