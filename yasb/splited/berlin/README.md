...
Full **Windhawk + YASB** customization using the [Berlin](https://github.com/xscriptor/xassets/blob/main/colors/colors.md) palette.
...
settings, borders, corners and menus) with the Berlin palette.
...
with hairline highlights, soft inner shadows and pressed states. The Berlin palette
...
| Token | Color | Usage |
|-------|-------|-------|
| `color0` / `background` | `#000000` / `#000000` | Bar background, surfaces |
| `color8` | `#333333` | Elevated surfaces, menus |
| `color7` / `foreground` | `#cccccc` | Text, icons |
| `color6` | `#cccccc` | Primary accent, active, hover |
| `color1` | `#999999` | Close window, power, warnings |
| `color2` | `#bbbbbb` | Battery, success |
| `color3` | `#dddddd` | Weather, alerts |
| `color4` | `#888888` | Disk, high load |
| `color5` | `#aaaaaa` | Media, network, GPU |
